...
// 
import footer from "../../assets/img/background_footer.png"


// nome do componente Home toda pg react e componete
function Home() {
...
function mostrarMenu() {
    ...
    return (
        <>
            <h1>Esta e a pagina Home O QUE QUE ESTO FAZENDO AQUI MEU!!!</h1>
